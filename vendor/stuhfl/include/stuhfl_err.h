...
#define STUHFL_ERR_ISO6B_NOTAG	                   STUHFL_D_APPLI_ERROR_TYPE (STUHFL_ERR_FIRST_ST25RU3993_ERROR - 60)  /*!< No response from any tag */
#define STUHFL_ERR_ISO6B_IRQ                       STUHFL_D_APPLI_ERROR_TYPE (STUHFL_ERR_FIRST_ST25RU3993_ERROR - 61)  /*!< IRQ error occured */
#define STUHFL_ERR_ISO6B_REG_FIFO                  STUHFL_D_APPLI_ERROR_TYPE (STUHFL_ERR_FIRST_ST25RU3993_ERROR - 62)  /*!< FIFO error occured */
#define STUHFL_ERR_ISO6B_OTHER	                   STUHFL_D_APPLI_ERROR_TYPE (STUHFL_ERR_FIRST_ST25RU3993_ERROR - 63)  /*!< Other error occurred */
#define STUHFL_ERR_ISO6B_ACCESS_TIMEOUT            STUHFL_D_APPLI_ERROR_TYPE (STUHFL_ERR_FIRST_ST25RU3993_ERROR - 64)  /*!< Tag access timeout */
